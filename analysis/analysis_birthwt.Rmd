...
I due grafici suggeriscono l'assenza di effetti di interazione significativi tra `age` e `race`
(si può infatti osservare l'assenza di un particolare pattern di distribuzione dei punti
tra i gruppi).
...
L'analisi anova conferma l'assenza di interazioni significative tra age e race,
mentre sono moderatamente significativi gli effetti principali di age e race.
Il singolo effetto di `age` non è invece significativo.
...
omoschedasticità e normalità dei residui. Non presenta punti particolarmente influenti.
