...
```{r}
logitResponse.modelVerify.verbose(formula = good ~ fico + loan_amnt + income + purpose, 
                                  response.var = 1, 
                                  regressors = 2:4, 
                                  data = loan,
                                  values = c("good", "bad"),
...
```
```{r}
logitResponse.modelVerify.verbose(formula = good ~ fico + loan_amnt, 
                                  response.var = 1, 
                                  regressors = 2:4, 
                                  data = loan,
                                  values = c("good", "bad"),
...
valutare classificatori di altro tipo, come il kNN

```{r}
knn.modelVerify.verbose(good ~ fico + loan_amnt + income + purpose, data = loan, values = c("good", "bad"), roc=T, response.var = "good")
```
