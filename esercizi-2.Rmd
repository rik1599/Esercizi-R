...
- Il secondo grafico evidenzia che i residui standardizzati si discostano significativamente dai quantili teorici per i valori non centrali. Questo, assieme a quanto emerso dal primo grafico, potrebbe suggerire che sarebbe appropriato valutare modelli più complessi, oppure di non considerare le osservazioni con mpg troppo elevato

- Dal quargo grafico si osserva un effetto leva non necessariamente corrispondente ad un alto residuo. Le distanze di cook sono contenute. 
