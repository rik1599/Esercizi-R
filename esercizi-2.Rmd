...
```{r}
cor.test(x = newMtcars$wt, y = newMtcars$mpg, method = "pearson")
cor.test(x = newMtcars$disp, y = newMtcars$mpg, method = "pearson")
cor.test(x = newMtcars$hp, y = newMtcars$mpg, method = "pearson")
```
