...
- Dal quarto grafico si osserva un effetto leva non necessariamente corrispondente ad un alto residuo. Le distanze di cook sono contenute, quindi si può affermare che nessun punto è particolarmente influente (ci sono un paio di punti vicini alla soglia del 0.5).
